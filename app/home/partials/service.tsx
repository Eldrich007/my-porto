...
const Service = () => {
  return (
    <Section
      tittle='Innovative IT Solutions for Your Business Growth'
      subtittle='We provide tailored, high-performance technology solutions to streamline operations, enhance security, and drive success.'
      id='services'
    >
      {/* Content */}
      <ServiceCards>
