...
const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  return (
    <SkewMotion asChild delay={animationDelay}>
      <div
        className={cn(
          'rounded-md bg-linear-to-b from-[#0093DD] to-transparent p-0.25',
          className
        )}
        style={{
      ...
      >
        ...
        >
          <div
            className={
              'bg-primary-300 flex-center aspect-square rounded-full shadow-[0_0_17px_rgba(0,147,221,0.6)] [&>*]:h-auto [&>*]:w-auto'
            }
            style={{
          ...
          <h3
            className='text-sm-semibold text-neutral-25'
            style={{
          ...
          <p
            className='text-sm-regular text-neutral-400'
            style={{
